...
<%@ page import="com.statecity.stateCityDTO"%>
<% stateCityDTO sc=(stateCityDTO)request.getAttribute("statecity"); %>
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>UMS - View State-City</title>
...
.lbl{flex:0 0 110px;font-size:12px;font-weight:600;color:#888;text-transform:uppercase;letter-spacing:.4px;}
...
<body><div class="card"><div class="icon">&#128506;</div><h2>State-City Mapping</h2>
<div class="row"><span class="lbl">ID</span><span class="val"><%=sc.getId()%></span></div>
<div class="row"><span class="lbl">State Code</span><span class="val"><%=sc.getStateCode()%></span></div>
<div class="row"><span class="lbl">City Code</span><span class="val"><%=sc.getCityCode()%></span></div>
<a href="statecityCntrl?opr=dashboard" class="btn-back">&#8592; Back to Dashboard</a>
</div></body></html>
