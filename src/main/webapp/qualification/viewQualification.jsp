...
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>UMS - View Qualification</title>
...
<body><div class="card"><div class="icon">&#127891;</div><h2>Qualification Details</h2>
<div class="row"><span class="lbl">ID</span><span class="val"><%=q.getId()%></span></div>
<div class="row"><span class="lbl">Code</span><span class="val"><%=q.getCode()%></span></div>
<div class="row"><span class="lbl">Name</span><span class="val"><%=q.getValue()%></span></div>
<a href="qualificationCntrl?opr=dashboard" class="btn-back">&#8592; Back to Dashboard</a>
</div></body></html>
