...
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>UMS - View State</title>
...
<body><div class="card"><div class="icon">&#127758;</div><h2>State Details</h2>
<div class="row"><span class="lbl">ID</span><span class="val"><%=state.getId()%></span></div>
<div class="row"><span class="lbl">Code</span><span class="val"><%=state.getCode()%></span></div>
<div class="row"><span class="lbl">Name</span><span class="val"><%=state.getValue()%></span></div>
<a href="stateCntrl?opr=dashboard" class="btn-back">&#8592; Back to Dashboard</a>
</div></body></html>
